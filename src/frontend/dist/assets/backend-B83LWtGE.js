...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, t as utf8ToBytes, E as ExternalError, w as MissingRootKeyErrorCode, C as Certificate, x as lookupResultToBuffer, y as RequestStatusResponseStatus, U as UnknownError, z as RequestStatusDoneNoReplyErrorCode, A as RejectError, D as CertifiedRejectErrorCode, F as UNREACHABLE_ERROR, I as InputError, G as InvalidReadStateRequestErrorCode, H as ReadRequestType, J as Principal, K as IDL, N as MissingCanisterIdErrorCode, O as HttpAgent, Q as encode, V as QueryResponseStatus, W as UncertifiedRejectErrorCode, X as isV3ResponseBody, Y as isV2ResponseBody, Z as UncertifiedRejectUpdateErrorCode, _ as UnexpectedErrorCode, $ as decode, i as Subscribable, a0 as pendingThenable, a1 as resolveEnabled, s as shallowEqualObjects, a2 as resolveStaleTime, m as noop, a3 as environmentManager, a4 as isValidTimeout, a5 as timeUntilStale, a6 as timeoutManager, a7 as focusManager, a8 as fetchState, a9 as replaceData, n as notifyManager, r as reactExports, p as shouldThrowError, u as useQueryClient, aa as useInternetIdentity, ab as createActorWithConfig, ac as Record, ad as Opt, ae as Variant, af as Vec, ag as Service, ah as Func, ai as Nat, aj as Nat8, ak as Text, al as Bool, am as Null, an as Int, ao as Principal$1, ap as Float64 } from "./index-idpaSJ1R.js";
...
const CreateVoiceProjectArgs = Record({
  "name": Text,
  "description": Text
});
const ProjectId = Nat;
const CloneStatus = Variant({
  "pending": Null,
  "processing": Null,
  "ready": Null,
  "failed": Text
...
const VoiceProjectView = Record({
  ...
  "createdAt": Timestamp,
  "description": Text,
  "elevenLabsVoiceId": Opt(VoiceId)
});
const SynthesisId = Nat;
const ExternalBlob$1 = Vec(Nat8);
const SynthesisSettings = Record({
  "stability": Float64,
  "style": Float64,
  "similarityBoost": Float64
});
const SynthesisRecordView = Record({
  "id": SynthesisId,
  "owner": UserId,
  "createdAt": Timestamp,
  "text": Text,
  "audioBlob": ExternalBlob$1,
  "settings": SynthesisSettings,
  "projectId": ProjectId
});
const VoiceSample = Record({
  "id": Nat,
  "owner": UserId,
  "blob": ExternalBlob$1,
  "filename": Text,
...
const StartCloningArgs = Record({
  "sampleIds": Vec(Nat),
  "projectId": ProjectId
});
const SynthesizeSpeechArgs = Record({
  "text": Text,
  "settings": SynthesisSettings,
  "projectId": ProjectId
});
...
Service({
  ...
  "createVoiceProject": Func(
    [CreateVoiceProjectArgs],
    [VoiceProjectView],
    []
  ),
  "deleteVoiceProject": Func([ProjectId], [Bool], []),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getUserApiKey": Func([], [Opt(Text)], ["query"]),
  "getVoiceProject": Func(
    [ProjectId],
    [Opt(VoiceProjectView)],
    ["query"]
  ),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "listSynthesisRecords": Func(
    [ProjectId],
    [Vec(SynthesisRecordView)],
    ["query"]
  ),
  "listVoiceProjects": Func([], [Vec(VoiceProjectView)], ["query"]),
  "listVoiceSamples": Func([ProjectId], [Vec(VoiceSample)], ["query"]),
  "registerClonedVoice": Func(
    [ProjectId, Text],
    [VoiceProjectView],
    []
  ),
  "setElevenLabsApiKey": Func([Text], [], []),
  "setUserApiKey": Func([Text], [], []),
  "startVoiceCloning": Func([StartCloningArgs], [Text], []),
  ...
  "uploadVoiceSample": Func(
    [ProjectId, Text, ExternalBlob$1],
    [Nat],
    []
  )
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const CreateVoiceProjectArgs2 = IDL2.Record({
    "name": IDL2.Text,
    "description": IDL2.Text
  });
  const ProjectId2 = IDL2.Nat;
  const CloneStatus2 = IDL2.Variant({
    "pending": IDL2.Null,
  ...
  const VoiceId2 = IDL2.Text;
  const VoiceProjectView2 = IDL2.Record({
    "id": ProjectId2,
    "status": CloneStatus2,
    "lastUsedAt": IDL2.Opt(Timestamp2),
    "owner": UserId2,
    "name": IDL2.Text,
    "createdAt": Timestamp2,
    "description": IDL2.Text,
    "elevenLabsVoiceId": IDL2.Opt(VoiceId2)
  });
  const SynthesisId2 = IDL2.Nat;
  const ExternalBlob2 = IDL2.Vec(IDL2.Nat8);
  const SynthesisSettings2 = IDL2.Record({
    "stability": IDL2.Float64,
    "style": IDL2.Float64,
    "similarityBoost": IDL2.Float64
  });
  const SynthesisRecordView2 = IDL2.Record({
    "id": SynthesisId2,
    "owner": UserId2,
    "createdAt": Timestamp2,
    "text": IDL2.Text,
    "audioBlob": ExternalBlob2,
    "settings": SynthesisSettings2,
    "projectId": ProjectId2
  });
  const VoiceSample2 = IDL2.Record({
    "id": IDL2.Nat,
    "owner": UserId2,
    "blob": ExternalBlob2,
    "filename": IDL2.Text,
  ...
  const StartCloningArgs2 = IDL2.Record({
    "sampleIds": IDL2.Vec(IDL2.Nat),
    "projectId": ProjectId2
  });
  const SynthesizeSpeechArgs2 = IDL2.Record({
    "text": IDL2.Text,
    "settings": SynthesisSettings2,
    "projectId": ProjectId2
  });
  ...
  return IDL2.Service({
    ...
    "createVoiceProject": IDL2.Func(
      [CreateVoiceProjectArgs2],
      [VoiceProjectView2],
      []
    ),
    "deleteVoiceProject": IDL2.Func([ProjectId2], [IDL2.Bool], []),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getUserApiKey": IDL2.Func([], [IDL2.Opt(IDL2.Text)], ["query"]),
    "getVoiceProject": IDL2.Func(
      [ProjectId2],
      [IDL2.Opt(VoiceProjectView2)],
      ["query"]
    ),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "listSynthesisRecords": IDL2.Func(
      [ProjectId2],
      [IDL2.Vec(SynthesisRecordView2)],
      ["query"]
    ),
    "listVoiceProjects": IDL2.Func([], [IDL2.Vec(VoiceProjectView2)], ["query"]),
    "listVoiceSamples": IDL2.Func(
      [ProjectId2],
      [IDL2.Vec(VoiceSample2)],
      ["query"]
    ),
    "registerClonedVoice": IDL2.Func(
      [ProjectId2, IDL2.Text],
      [VoiceProjectView2],
      []
    ),
    "setElevenLabsApiKey": IDL2.Func([IDL2.Text], [], []),
    "setUserApiKey": IDL2.Func([IDL2.Text], [], []),
    "startVoiceCloning": IDL2.Func([StartCloningArgs2], [IDL2.Text], []),
    "synthesizeSpeech": IDL2.Func(
      [SynthesizeSpeechArgs2],
      [SynthesisRecordView2],
      []
    ),
    "transform": IDL2.Func(
    ...
    "uploadVoiceSample": IDL2.Func(
      [ProjectId2, IDL2.Text, ExternalBlob2],
      [IDL2.Nat],
      []
    )
  });
...
class Backend {
  ...
  async listSynthesisRecords(arg0) {
    if (this.processError) {
      try {
  ...
  async registerClonedVoice(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async setElevenLabsApiKey(arg0) {
    if (this.processError) {
      try {
  ...
  async uploadVoiceSample(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
function from_candid_CloneStatus_n12(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
async function from_candid_ExternalBlob_n23(_uploadFile, _downloadFile, value) {
  return await _downloadFile(value);
}
async function from_candid_SynthesisRecordView_n21(_uploadFile, _downloadFile, value) {
...
function from_candid_VoiceProjectView_n10(_uploadFile, _downloadFile, value) {
  return from_candid_record_n11(_uploadFile, _downloadFile, value);
}
async function from_candid_VoiceSample_n26(_uploadFile, _downloadFile, value) {
...
async function from_candid_record_n27(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    owner: value.owner,
...
async function from_candid_vec_n25(_uploadFile, _downloadFile, value) {

import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, R as React, d as composeRefs, o, e as useComposedRefs, a as cn, B as Button, f as Slot, g as cva } from "./index-idpaSJ1R.js";
/**
...
function useAudioPlayer() {
  ...
  const [volume, setVolumeState] = reactExports.useState(1);
  ...
  const play = reactExports.useCallback(() => {
    var _a;
    (_a = audioRef.current) == null ? void 0 : _a.play().then(() => setIsPlaying(true)).catch(() => {
    });
  }, []);
  ...
  const seek = reactExports.useCallback((time) => {
    if (audioRef.current) {
      audioRef.current.currentTime = time;
      setCurrentTime(time);
    }
  }, []);
  const setVolume = reactExports.useCallback((vol) => {
  ...
  const load = reactExports.useCallback((url) => {
    if (audioRef.current) {
...
function WaveformViz({ isPlaying }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0.5 h-8 flex-1", children: bars.map(({ h, key }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: cn(
  ...
  if (!src) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-display uppercase tracking-wide", children: "No audio loaded" })
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(WaveformViz, { isPlaying: player.isPlaying }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs font-mono text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatTime(player.currentTime) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatTime(player.duration) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: player.isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { className: "w-3.5 h-3.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-3.5 h-3.5" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
          ...
          !compact && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 ml-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "ghost",
                ...
                children: player.volume > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "w-3 h-3 text-muted-foreground" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeX, { className: "w-3 h-3 text-muted-foreground" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Slider,
